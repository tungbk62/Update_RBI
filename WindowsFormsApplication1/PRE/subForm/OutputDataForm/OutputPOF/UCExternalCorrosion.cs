...
namespace RBI.PRE.subForm.OutputDataForm.OutputPOF
{
    public partial class UCExternalCorrosion : UserControl
    {
        ...
        public UCExternalCorrosion(int ID)
        {
            InitializeComponent();
            initinput(ID);
            //Calculate();
        ...
        private void initinput(int ID)
        {
            ...
            txtDesignPressure.Text = Convert.ToString(material.DesignPressure);
            txtExternalQuality.Text = coat.ExternalCoatingQuality;
            txtLevelConfidence.Text = component.ConfidenceCorrosionRate;
            txtSupport.Text = Convert.ToString(coat.SupportConfigNotAllowCoatingMaint);
            txtMinMeasured.Text = "E"; ;
            txtMinRequired.Text = Convert.ToString(component.MinReqThickness);
            txtMinRequired1.Text = Convert.ToString(component.MinReqThickness);
            txtDiameter.Text = "E"; ;
            txtExternalCoating.Text = Convert.ToString(coat.ExternalCoating);
            txtInterfaceSoil.Text = Convert.ToString(eq.InterfaceSoilWater);
            txtExternalEnvironment.Text = eq.ExternalEnvironment;
            txtNumberA.Text = "E";
            txtNumberB.Text = "E";
            txtNumberC.Text = "E";
            txtNumberD.Text = "E";
