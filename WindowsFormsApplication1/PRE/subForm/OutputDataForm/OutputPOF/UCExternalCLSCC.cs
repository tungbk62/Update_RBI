...
namespace RBI.PRE.subForm.OutputDataForm.OutputPOF
{
    public partial class UCExternalCLSCC : UserControl
    {
        ...
        private void initinput(int ID)
        {
            ...
            txtPresenceCracks.Text = component.CracksPresent != 1 ? "False" : "True";
            txtQuality.Text = coat.ExternalCoatingQuality;
            txtExternalEnvironment.Text = eq.ExternalEnvironment;
            txtExternalCoatingInstallationDate.Text = Convert.ToString(coat.ExternalInsulation);
        }
