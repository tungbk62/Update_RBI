...
{
    public partial class UCHydrogenStressCracking_HSC_HF_ : UserControl
    {
        public UCHydrogenStressCracking_HSC_HF_()
        {
            InitializeComponent();
        }
        public UCHydrogenStressCracking_HSC_HF_(int ID)
        {
            InitializeComponent();
            initinput(ID);
            //Calculate();
        ...
        private void initinput(int ID)
        {
            ...
            txtPH.Text = eq.PWHT != 1 ? "False" : "True";
            ...
            txtPresenceAcid.Text = Convert.ToString(stream.Hydrofluoric);
            txtMaxiumumWeld.Text = component.BrinnelHardness;
        }
